function f(){
    document.getElementById("c").src="imgs/pic.jpg";
}


function f1(){
    document.getElementById("c").src="imgs/pic.jpg";
    document.getElementById("cname").innerHTML = "MANU SRIRAM";
}
...
localStorage.setItem("username","manu");
